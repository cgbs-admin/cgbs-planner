  ...
  useEffect(() => {
    const loadPlanningLevels = async () => {
      try {
        ...
        console.log("CreateEventWizard /planning-levels response", raw);
        ...
        if (Array.isArray(json)) {
          ...
          console.error("Unexpected /planning-levels response", json);
          data = [];
        }
...
{step === 2 && eventType === "GOTTESDIENST" && (
  <div className="flex flex-col gap-4">
    ...
    <p className="text-sm text-gray-600">
      Bitte wählen Sie das Datum für den Gottesdienst. Die Kalenderansicht
      bleibt sichtbar, bis Sie mit „Weiter“ fortfahren.
    </p>
